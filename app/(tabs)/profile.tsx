...
const Profile = () => {
  ...
  const { user, isLoading, isAuthenticated, setUser, setIsAuthenticated } =
    useAuthStore();
...
Leitet zur Anmeldeseite weiter */}
          ...
          <>
            ...
            <Text className="text-light-200 text-base text-center">
              Um Filme zu speichern und auf dein Profil zuzugreifen, melde dich
              bitte an oder erstelle ein Konto.
            </Text>
